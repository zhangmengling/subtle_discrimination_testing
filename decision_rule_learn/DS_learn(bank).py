...
# all_itemsets = [['age=(1, 8)']]
all_itemsets = [['age=(1,5)']]
...
all_fair_scores = []
all_scores = []
for itemset in new_all_itemsets:
...
print("-->itemset for max fairness score", new_all_itemsets[all_fair_scores.index(max(all_fair_scores))])
