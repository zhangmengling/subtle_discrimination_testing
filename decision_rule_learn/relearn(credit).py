...
# all_itemsets = [['sex=0', 'age=(6, 7)'], ['sex=0', 'age=6']]

all_itemsets = [['sex=1', 'age=(1, 2)']]
for itemset in all_itemsets:
    print("-->itemset:", itemset)
    # all_data = generate_random_data_itemset(1000, conf, sess, x, preds, itemset, True)
    generated_data = generate_pert_samples_with_labels(list(X), conf, 100, itemset, sess, x, preds, True, True)

print("-->generated_data")
print(generated_data)
file_path = "../dataset/credit_2.csv"
