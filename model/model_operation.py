...
def training(dataset, model_path):
    ...
    data = {"census": census_data, "credit": credit_data, "bank": bank_data, "compas": compas_data,
            "law_school": law_school_data, "communities": communities_data, "segment": segment_data}
...
if __name__ == '__main__':
    flags.DEFINE_string("dataset", "segment", "the name of dataset")
    flags.DEFINE_string("model_path", "../models/gesture_segment/", "the name of path for saving model") #census-->credit
